...
def parse_args(args, parser):
    ...
    parser.add_argument('--num_sats', type=int, default=6, help="number of satellites")
    parser.add_argument('--num_services', type=int, default=5, help="number of service instances")
    # 其他卫星相关参数...
